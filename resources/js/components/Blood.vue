    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="card-header print-hide">
                <h3 class="card-title green">Bloods</h3>

                <div class="card-tools">
                    <button type="button" class="btn btn-success" @click="addNewbloodModalOpen"> Add New Blood
                ...
                <tbody>
                    <tr role="row" class="odd" v-for="(blood, index) in bloods" :key="index">
                        ...
                        <td>
                            ...
                            <a href="#" @click="editblood(blood)" class="btn btn-primary"><i class="fas fa-edit"></i></a> ||
                            <a href="#" @click="deleteblood(blood.id)" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                        </td>
    ...
    export default {
        ...
        methods: {
            ...
            udpateblood(){
                this.$Progress.start()
                //Server request
                this.form.put('api/blood/'+this.form.id)
                .then(() => {
        ...
        created() {
            Fire.$on("searching", ()=> {
                ...
                axios.get('api/findblood?q='+ query)
                .then((data)=>{
            ...
            this.loadbloods();
            //setInterval(() => { this.loadbloods(); }, 500);
